...
interface SellCardGridProps {
  cards: UserCard[]
  onCardClick: (card: UserCard) => void
}

export default function SellCardGrid({ cards, onCardClick }: SellCardGridProps) {
  ...
  if (cards.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="text-lg font-medium text-gray-900 mb-2">No cards for sale</h3>
        <p className="text-gray-600">Use the bulk import feature to add cards to your inventory.</p>
      </div>
    )
  }
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold text-gray-900">Your Cards ({cards.length.toLocaleString()})</h2>
            ...
            <CardContent className="p-3">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-lg font-bold text-green-600">${card.sellingPrice.toFixed(2)}</div>
                    <div className="text-xs text-gray-600">Stock: {card.quantity}</div>
                  </div>
